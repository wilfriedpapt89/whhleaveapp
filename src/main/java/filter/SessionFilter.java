...
public class SessionFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		String signupURL = req.getContextPath() + "/compte.xhtml";
		...
		boolean signupRequest = req.getRequestURI().equals(signupURL);
		...
		if (loggedIn || loginRequest || resourceRequest || signupRequest) {
